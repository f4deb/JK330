...
static const char* myHelloStr1="       PIC32... on            LCD By Jerome             For JK330             November 2013    \n";
...
int main(void)
{ 	
	PORTSetPinsDigitalOut(IOPORT_D,RS);
	PORTSetPinsDigitalOut(IOPORT_F,E|RW);
	PORTSetPinsDigitalOut(IOPORT_E,D0|D1|D2|D3|D4|D5|D6|D7);

	PORTClearBits(IOPORT_D,RS);
	PORTClearBits(IOPORT_F, E|RW);
