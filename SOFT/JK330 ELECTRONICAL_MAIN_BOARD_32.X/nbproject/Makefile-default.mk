...
SOURCEFILES_QUOTED_IF_SPACED=../common/delay/delay.c ../common/I2C/I2Ccommon.c ../common/io/printWriter.c ../common/serial/serial.c ../device/led/led.c ../drivers/lcd/lcd24064.c ../main/MainJK330.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1309593678/delay.o ${OBJECTDIR}/_ext/637770267/I2Ccommon.o ${OBJECTDIR}/_ext/1544592837/printWriter.o ${OBJECTDIR}/_ext/1922645879/serial.o ${OBJECTDIR}/_ext/1041058175/led.o ${OBJECTDIR}/_ext/649236794/lcd24064.o ${OBJECTDIR}/_ext/760813400/MainJK330.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1309593678/delay.o.d ${OBJECTDIR}/_ext/637770267/I2Ccommon.o.d ${OBJECTDIR}/_ext/1544592837/printWriter.o.d ${OBJECTDIR}/_ext/1922645879/serial.o.d ${OBJECTDIR}/_ext/1041058175/led.o.d ${OBJECTDIR}/_ext/649236794/lcd24064.o.d ${OBJECTDIR}/_ext/760813400/MainJK330.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1309593678/delay.o ${OBJECTDIR}/_ext/637770267/I2Ccommon.o ${OBJECTDIR}/_ext/1544592837/printWriter.o ${OBJECTDIR}/_ext/1922645879/serial.o ${OBJECTDIR}/_ext/1041058175/led.o ${OBJECTDIR}/_ext/649236794/lcd24064.o ${OBJECTDIR}/_ext/760813400/MainJK330.o

# Source Files
SOURCEFILES=../common/delay/delay.c ../common/I2C/I2Ccommon.c ../common/io/printWriter.c ../common/serial/serial.c ../device/led/led.c ../drivers/lcd/lcd24064.c ../main/MainJK330.c
